...
folder_path = r"C:\Users\e123197\My Drive\ROO_Daily Data\New_requests"
            ...
            if file_name.lower().endswith('.json') and 'observation' in file_name.lower():
                ...
                with open(json_file_path, 'r') as json_file:
                    ...
                    if target_time is not None:
                        ...
                        slewing_time = target_datetime - datetime.timedelta(minutes=1)
                        ...
                        if current_time < slewing_time:
                            ...
                            if len(scheduled_observations) == 0:
                                if 'ra' in data:
                                    scheduled_observations.append((meas_type, target_datetime, target_ra, target_dec, exposure_time, file_name))
                                elif 'az' in data:
                                    scheduled_observations.append((meas_type, target_datetime, target_az, target_el, exposure_time, file_name))
                            else:
                                ...
                                if scheduled_observations[len(scheduled_observations)-1][5] != file_name: #Attempt to stop same observation being appeded, needs fixing!!
                                    if 'ra' in data:
                                        scheduled_observations.append((meas_type, target_datetime, target_ra, target_dec, exposure_time, file_name))
...
def check_shutter_status_and_record_observation(teleobj, domeObj, camObj, observation, folder_path):
    ...
    if observation[0] == "radec":
        meas_type, target_datetime, target_ra, target_dec, exposure_time, file_name = observation
    elif observation[0] == "azel":
        meas_type, target_datetime, target_az, target_el, exposure_time, file_name = observation
